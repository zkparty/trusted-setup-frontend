...
* @returns {any}
*/
export function contribute_wasm(input, string_secret, string_identity) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(string_secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(string_identity, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.contribute_wasm(ptr0, len0, ptr1, len1, ptr2, len2);
    return takeObject(ret);
}
...
* @returns {any}
*/
export function get_pot_pubkeys_wasm(string_secret) {
    const ptr0 = passStringToWasm0(string_secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_pot_pubkeys_wasm(ptr0, len0);
    return takeObject(ret);
}
