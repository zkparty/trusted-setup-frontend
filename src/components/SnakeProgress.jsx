...
export default function SnakeProgress({ onSetPlayer }) {
        ...
        animations: [
          {
            ...
            s: ''
          }
        ],
        options:
          'MDIAxODhhMzE4MCjgzNzA4MTgzNMzFDNDkzMTdTmODFJN2U3NjEgxNzBBN2NQNB2M3MDgzNzhIINzIzMThj'
      },
      '__SVGATOR_PLAYER__',
      window
    )
  ...
  useEffect(() => {
    const element = document.getElementById('eFB6LHtki1R1')
